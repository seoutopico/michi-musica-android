...
**Código integrado en main:** [PR #3](https://github.com/seoutopico/michi-musica-android/pull/3), commit `ba3ff3a5646aceb332e5ad1ed6d7ae91e10e66a6`. La instalación final sí está completada. La revisión automática rechazó subir los seis archivos de la release porque consideró insuficiente la autorización anterior de Git para este payload público. Solicitada autorización explícita a Aina para publicar APK 1.14.0 y sus cinco adjuntos habituales; no reintentar la subida hasta recibirla. Los archivos y hashes están preparados en `dist/1.14.0/` y `dist/sources/`; notas en `tmp/release-1.14.0.md`. 1.13.0 sigue siendo la release pública hasta completar ese paso. Tras la autorización, crear borrador, verificar tamaño/SHA-256 de los seis adjuntos remotos, publicar como estable/latest y registrar el cierre.
